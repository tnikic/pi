/**
 * Real pi process adapter — spawns a child process, streams JSON events,
 * enforces safety caps, and returns a SubagentResult.
 *
 * Implements the SpawnFn interface so callers can inject a fake process
 * for integration testing (see Candidate 2).
 */
...
/**
 * Real process spawner: starts a pi child process, streams JSON events,
 * enforces safety caps, and returns a SubagentResult.
 */
export const spawnSubprocess: SpawnFn = async (
	config: EngineConfig,
